...
namespace WaferMapTest.ConsoleApp;
...
public class ConsoleAppHostedService : IHostedService
{
    ...
    public ConsoleAppHostedService(HelloWorldService helloWorldService, IAbpApplicationWithExternalServiceProvider abpApplication)
    {
